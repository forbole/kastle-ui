import{j as t,V as o,s as n,a as c,b as i}from"./theme-DsIVqOpk.js";import{S as d}from"./StatusPill-B3c2GzRL.js";import"./iframe-Be-tza-6.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-DW8tFxrq.js";import"./createLucideIcon-Bg0PyGW2.js";import"./registry-BNXumi8c.js";import"./circle-x-BmYyq0jL.js";import"./index-CQ0gql0M.js";const j={title:"Components/StatusPill",component:d,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:p.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},p=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
