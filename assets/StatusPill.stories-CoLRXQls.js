import{j as t,V as o,s as n,a as c,b as i}from"./theme-14-nfLmN.js";import{S as p}from"./StatusPill-BRdjC5ep.js";import"./iframe-CPbwvuc0.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-a8tatRxm.js";import"./createLucideIcon-BO3burch.js";import"./registry-BNXumi8c.js";import"./circle-x-B_Izdves.js";import"./circle-check-by9q17HE.js";import"./index-CZoP2qMM.js";const h={title:"Components/StatusPill",component:p,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:d.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},d=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
