import{j as t,V as o,s as n,a as c,b as i}from"./theme-ryBZVJ3B.js";import{S as d}from"./StatusPill-CMpIW5b0.js";import"./iframe-BZw4JuSd.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-BE_wp-bn.js";import"./createLucideIcon-BdiV1HJI.js";import"./registry-BNXumi8c.js";import"./circle-x-BatowT-q.js";import"./index-008s76Nf.js";const j={title:"Components/StatusPill",component:d,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:p.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},p=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
