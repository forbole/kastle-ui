import{j as t,V as o,s as n,a as c,b as i}from"./theme-BR8GLPde.js";import{S as p}from"./StatusPill-E6X6cdl1.js";import"./iframe-CPNBp_1P.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-KIh0pZLE.js";import"./createLucideIcon-CMBOrzhh.js";import"./registry-BNXumi8c.js";import"./circle-x-D6cIRgJE.js";import"./circle-check-i_o_1MkC.js";import"./index-CH8DnRWL.js";const h={title:"Components/StatusPill",component:p,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:d.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},d=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
