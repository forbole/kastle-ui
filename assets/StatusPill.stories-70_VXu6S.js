import{j as t,V as o,s as n,a as c,b as i}from"./theme-3E0Q3OwC.js";import{S as d}from"./StatusPill-D_QSlQoO.js";import"./iframe-CiAE8p3U.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-CuruH1qI.js";import"./createLucideIcon-BxdLEERx.js";import"./registry-BNXumi8c.js";import"./circle-x-CIwtDNCq.js";import"./index-CrU1b8Ao.js";const j={title:"Components/StatusPill",component:d,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:p.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},p=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
