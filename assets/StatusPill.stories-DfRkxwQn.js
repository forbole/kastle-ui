import{j as t,V as o,s as n,a as c,b as i}from"./theme-3BxVJlir.js";import{S as d}from"./StatusPill-BlopvNy9.js";import"./iframe-v1nfq64w.js";import"./preload-helper-Zf8nSx-t.js";import"./clock-fading-DfoN3t4t.js";import"./createLucideIcon-8rFYW_zW.js";import"./registry-BNXumi8c.js";import"./circle-x-CNx0vHV-.js";import"./index-ClSautIe.js";const j={title:"Components/StatusPill",component:d,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[a=>t.jsx(o,{style:p.decorator,children:t.jsx(a,{})})]},s={args:{status:"success"}},e={args:{status:"failed"}},r={args:{status:"pending"}},p=n.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:i.bg0,padding:c.s5}});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
