import{j as n,V as d,s as c,a as p,b as m}from"./theme-CMj5SAcx.js";import{S as u}from"./StatusPill-CQyNlZRe.js";import"./iframe-Dlitb8YL.js";import"./preload-helper-Zf8nSx-t.js";import"./undo-2-Dh3ogrv6.js";import"./createLucideIcon-CsQHbI7R.js";import"./registry-BNXumi8c.js";import"./index-Dl0GLfCf.js";import"./circle-x-BSxALxBq.js";import"./circle-check-DSoY26yi.js";const w={title:"Components/StatusPill",component:u,parameters:{backgrounds:{default:"kastle"},viewport:{defaultViewport:"iphone14"}},decorators:[i=>n.jsx(d,{style:l.decorator,children:n.jsx(i,{})})]},e={args:{status:"success"}},s={args:{status:"failed"}},r={args:{status:"pending"}},t={args:{status:"refunded"}},a={args:{status:"pending",label:"Submitted"}},o={args:{status:"pending",label:"Confirmed"}},l=c.create({decorator:{flex:1,alignItems:"center",justifyContent:"center",backgroundColor:m.bg0,padding:p.s5}});e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    status: "success"
  }
...
}`,...o.parameters?.docs?.source},description:{story:'Bridge Activity label override — still status="pending" under the hood',...o.parameters?.docs?.description}}};const k=["Success","Failed","Pending","Refunded","Submitted","Confirmed"];export{o as Confirmed,s as Failed,r as Pending,t as Refunded,a as Submitted,e as Success,k as __namedExportsOrder,w as default};
